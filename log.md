...
## [2026-09-08] processing | Обработка 3 ссылок очереди (TikTok, Instagram Reels, Instagram Carousel)

- **Контекст:** Обработка новых ссылок очереди (`2026-09-07-001`, `2026-09-07-002`, `2026-09-07-003`).
- **Что сделано:**
  1. `2026-09-07-001` (TikTok): аудио успешно транскрибировано на русском языке, материалы сохранены в full, slim и Google Sheets.
  2. `2026-09-07-002` (Instagram Reels): порог `_is_weak_transcript` скорректирован до `<= 5` слов для запуска покадрового OCR при наличии коротких музыкальных дорожек/галлюцинаций Whisper. Извлечён полный текст цитат с экрана видео (Фромм, Боулби, Эллис), материалы синхронизированы в full, slim и Google Sheets.
  3. `2026-09-07-003` (Instagram Carousel): извлечён русский текст со всех 19 слайдов карусели, материалы сохранены в full, slim и Google Sheets.
  4. Аудит `audit_translations.py`: 0 дефектов, 0 рассинхронов.
  5. Тесты пройдены: `seed_pipeline` 43/43, `telegram_intake_bot` 52/52 (все 95 тестов).
